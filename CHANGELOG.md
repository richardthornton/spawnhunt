...
- A hunt started in a singleplayer or LAN world stayed active in the next world opened, with the timer still counting through the main menu
- On a server, a player in creative could take the target straight from the creative inventory and instantly win for everyone; wins now require survival or adventure mode
- Choosing a target and then backing out of world creation left the hunt armed, and its timer would start on whatever world or server you joined next

### Improved

- Smoother item chooser and various bugfixes in how the SpawnHunt is rendered
